...
<head>
    ...
    <link href="{{ asset('assets/backend/plugins/custom/prismjs/prismjs.bundle.css') }}" rel="stylesheet"
        type="text/css">
    <link href="{{ asset('assets/backend/css/style.bundle.css') }}" rel="stylesheet" type="text/css">
    <!--end::Global Theme Styles-->
    <!--begin::Layout Themes(used by all pages)-->
    <link href="{{ asset('assets/backend/css/themes/layout/header/base/light.css') }}" rel="stylesheet"
        type="text/css">
    <link href="{{ asset('assets/backend/css/themes/layout/header/menu/light.css') }}" rel="stylesheet"
        type="text/css">
    ...
    <!--end::Layout Themes-->
    <link rel="shortcut icon" href="{{ asset('assets/backend/media/logos/logo-1new.png') }}">
    <!--begin::Page Vendors Styles(used by this page)-->
...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        ...
        <a href="{{route('admin.leads.index')}}">
            <img alt="Logo" src="{{ asset('assets/backend/media/logos/logo-2new.png') }}" class="h-100px" />
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
        ...
        <div class="d-flex flex-row flex-column-fluid page">
            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="brand flex-column-auto" id="kt_brand">
                    <!--begin::Logo-->
                    <a href="{{route('admin.leads.index')}}" class="brand-logo">
                        <img alt="Logo" src="{{ asset('assets/backend/media/logos/logo-1new.png') }}"
                            class="h-100px" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Toggle-->
                ...
                <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                        ...
                        <!--begin::Menu Nav-->
                        <ul class="menu-nav">
                            <li class="menu-item {{(Route::currentRouteName()  == 'admin.leads.index') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                            ...
                            <li class="menu-item {{(Route::currentRouteName()  == 'admin.customers.index') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                            ...
                            <li class="menu-item {{(Route::currentRouteName()  == 'admin.tasks.index') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                            ...
                            <li class="menu-item {{(Route::currentRouteName()  == 'admin.contacts.index') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                            ...
                            <li class="menu-item {{(Route::currentRouteName()  == 'admin.reports') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                            ...
                            <li class="menu-item {{(Route::currentRouteName()  == 'admin.users.index') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                            ...
                            <li class="menu-item {{(Route::currentRouteName()  == 'admin.settings') ? 'menu-item-active' : '' }}" aria-haspopup="true">
						...
						<div class="topbar">
							<div class="dropdown">
								<button class="btn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									...
									<img src="{{asset(session('profile_avatar'))}}" class="h-40px align-self-end" alt="" style="border-radius: 25px;" />
									<!-- </div> -->
								</button>
            ...
            <div class="pt-5">
                ...
                <div class="bg-gray-100 d-flex align-items-center p-5 rounded gutter-b">
                    ...
                    <div class="ml-1">
                        ...
                        <p class="m-0 text-dark-50 font-weight-bold">Lorem Ipsum is simply dummy text of the printing
                            and industry.</p>
                    </div>
                    <!--end::Description-->
                </div>
                ...
                <div class="bg-gray-100 d-flex align-items-center p-5 rounded gutter-b">
                    ...
                    <div class="ml-1">
                        ...
                        <p class="m-0 text-dark-50 font-weight-bold">There are many variations of passages of Lorem
                            Ipsum available.</p>
                    </div>
                    <!--end::Description-->
                </div>
                ...
                <div class="bg-gray-100 d-flex align-items-center p-5 rounded gutter-b">
                    ...
                    <div class="ml-1">
                        ...
                        <p class="m-0 text-dark-50 font-weight-bold">Contrary to popular belief, Lorem Ipsum is not
                ...
                <div class="bg-gray-100 d-flex align-items-center p-5 rounded gutter-b">
                    ...
                    <div class="ml-1">
                        ...
                        <p class="m-0 text-dark-50 font-weight-bold">If you are going to use a passage of Lorem Ipsum,
                            you need.</p>
                    </div>
                    <!--end::Description-->
                </div>
    ...
    <!--end::Page Vendors-->
    <!--begin::Page Scripts(used by this page)-->
    <script src="{{ asset('assets/backend/js/pages/features/datatables/basic/scrollable.js') }}"></script>

    <script src="{{ asset('assets/backend/js/pages/features/ktdatatable/base/html-table.js') }}"></script>
    <!--end::Page Scripts-->
    <!--begin::Page Scripts(used by this page)-->
    <script src="{{ asset('assets/backend/js/pages/features/calendar/basic.js') }}"></script>
    <!--end::Page Scripts-->
    <!-- edit-user - settings -->
    <script src="{{ asset('assets/backend/js/pages/custom/user/edit-user.js') }}"></script>
    <!-- close -->
    ...
    {{-- <script type="text/javascript">
		...
		$("#mailingAddressCheckbox").click(function() {
			if ($(this).is(":checked")) {
				$(".mailing_address_div").hide("slow");
			} else {
				$(".mailing_address_div").show("slow");
			}
		});
	}); --}}
    ...
    <script type="text/javascript">
        $('#notes_choice input').on('change', function() {
            var value = $('input[name=note_type]:checked', '#notes_choice').val();
            console.log("note"+value);
            if (value == 'note') {
                // $('.task_notes').hide('slow');
                $('.task_notes').children().attr("disabled", "disabled");
                $('.task_notes').hide('slow');
            }
            if (value == 'task') {
                $('.task_notes').show('slow');
                $(".note_field").children().attr("disabled", "disabled");
            }


        });

        $('#customer_notes_choice input').on('change', function() {
            var value = $('input[name=customer_note_type]:checked', '#customer_notes_choice').val();
            console.log("note"+value);
            if (value == 'note') {
                // $('.task_notes').hide('slow');
                $('.customer_task_notes').children().attr("disabled", "disabled");
                $('.customer_task_notes').hide('slow');
            }
            if (value == 'task') {
                $('.customer_task_notes').show('slow');
                // $(".customer_note_field").children().attr("disabled", "disabled");
            }


        });
        $(document).on('click', '#click_new_customer', function() {
            $('#new_customer').show('slow');
            $('#closed_account').hide('slow');
            $('#ninty_day').hide('slow');
            $('#new_location').hide('slow');
        });
        $(document).on('click', '#click_closed_account', function() {
            $('#closed_account').show('slow');
            $('#new_customer').hide('slow');
            $('#ninty_day').hide('slow');
            $('#new_location').hide('slow');
        });
        $(document).on('click', '#click_new_location', function() {
            $('#new_location').show('slow');
            $('#new_customer').hide('slow');
            $('#ninty_day').hide('slow');
            $('#closed_account').hide('slow');
        });
        $(document).on('click', '#click_ninty_day', function() {
            $('#ninty_day').show('slow');
            $('#new_customer').hide('slow');
            $('#new_location').hide('slow');
            $('#closed_account').hide('slow');
        ...
        $(document).on('click', '#deny_reason', function() {
            $('#show_deny_reason').toggle();
        ...
        var KTCalendarBasic = function() {
            ...
            return {
                ...
                init: function() {
                    ...
                    var calendarEl = document.getElementById('kt_calendar_user');
        ...
        $(document).delegate('.editfields', 'click', function() {
            $(this).hide();
            $('.editfieldscancel').show();
            $('.text-muted').show();
            $('.input-group-append').css('opacity', 1);
            $('input').each(function() {
        ...
        $(document).delegate('.editfieldscancel', 'click', function() {
            $(this).hide();
            $('.editfields').show();
            $('input').each(function() {
                $(this).addClass('notedit');
                $(this).attr('readonly', 'readonly');
            });
            $('.editaction').hide();
            $('.text-muted').hide();
            $('.input-group-append').css('opacity', 0);
        })

        $(".alert").delay(3000).fadeOut(800);

        // adding customer mailing address checkbox
        $(function() {
            $("#mailingAddressCheckbox").click(function() {
                if ($(this).is(":checked")) {
                    $(".mailing_address_div").hide("slow");
        ...
        // adding Secondary location checkbox
        $(function() {
            $("#addSecondaryLocation").click(function() {
                if ($(this).is(":checked")) {
                    $(".secondary_location_div").show("slow");
                } else {
                    $(".secondary_location_div").hide("slow");
                }
            });
        });

        // Setting up the CVV on select choice
        function changeValue(dropdown) {
            var option = dropdown.options[dropdown.selectedIndex].value,
                field = document.getElementById('cvv');

            if (option == 'VISA' || option == 'MAST' || option == 'DISC') {
                field.value = field.value.substr(0,
                2); // before reducing the maxlength, make sure it contains at most two characters; you could also reset the value altogether
                field.maxLength = 3;
            } else {
                field.maxLength = 4;
            }
            ...
            var option = dropdown.options[dropdown.selectedIndex].value,
                cardnumberfield = document.getElementById('cardnumber');

            if (option == 'VISA' || option == 'MAST' || option == 'DISC') {
                cardnumberfield.value = cardnumberfield.value.substr(
                15); // before reducing the maxlength, make sure it contains at most two characters; you could also reset the value altogether
                cardnumberfield.maxLength = 16;
            } else {
                cardnumberfield.maxLength = 15;
            }
        }
        ...
        var url = "http://localhost/gymitless/administrator/close_account/";
        ...
        document.getElementById('userNumber').addEventListener('keyup', function(evt) {
            var userNumber = document.getElementById('userNumber');
            var charCode = (evt.which) ? evt.which : evt.keyCode;
            userNumber.value = phoneFormat(userNumber.value);
        });

        // We need to manually format the phone number on page load
        document.getElementById('userNumber').value = phoneFormat(document.getElementById('userNumber').value);

        // Format the phone number as the user types it
        document.getElementById('userNumberEdit').addEventListener('keyup', function(evt) {
            var userNumberEdit = document.getElementById('userNumberEdit');
            var charCode = (evt.which) ? evt.which : evt.keyCode;
            userNumberEdit.value = phoneFormat(userNumberEdit.value);
        });

        // We need to manually format the phone number on page load
        document.getElementById('userNumberEdit').value = phoneFormat(document.getElementById('userNumberEdit').value);
...
<script type="text/javascript">
	$(document).on('change', '#payment_method', function() {
		...
		if (value == 'bank_account') {
			$('.bank_account').show('slow');
			$('.credit_card').hide('slow');
		}
		if (value == 'credit_card') {
			$('.credit_card').show('slow');
			$('.bank_account').hide('slow');
		}
		if (value == 'select_payment_method') {
			$('.credit_card').hide('slow');
			$('.bank_account').hide('slow');
		}
	});

    $(document).on('change', '#monday_opentime', function() {
		is_monday_open = $(this).val();
		if(is_monday_open == "close"){
            $('#monday_close_time').hide('slow');
        }else{
            $('#monday_close_time').show('slow');
        }
	});

    $(document).on('change', '#tuesday_opentime', function() {
		is_tuesday_open = $(this).val();
		if(is_tuesday_open == "close"){
            $('#tuesday_closetime').hide('slow');
        }else{
            $('#tuesday_closetime').show('slow');
        }
	});

    $(document).on('change', '#wednesday_opentime', function() {
		is_wednesday_open = $(this).val();
		if(is_wednesday_open == "close"){
            $('#wednesday_closetime').hide('slow');
        }else{
            $('#wednesday_closetime').show('slow');
        }
	});

    $(document).on('change', '#thursday_opentime', function() {
		is_thursday_open = $(this).val();
		if(is_thursday_open == "close"){
            $('#thursday_closetime').hide('slow');
        }else{
            $('#thursday_closetime').show('slow');
        }
	});

    $(document).on('change', '#friday_opentime', function() {
		is_friday_open = $(this).val();
		if(is_friday_open == "close"){
            $('#friday_closetime').hide('slow');
        }else{
            $('#friday_closetime').show('slow');
        }
	});

    $(document).on('change', '#saturday_opentime', function() {
		is_saturday_open = $(this).val();
		if(is_saturday_open == "close"){
            $('#saturday_closetime').hide('slow');
        }else{
            $('#saturday_closetime').show('slow');
        }
	});

    $(document).on('change', '#sunday_opentime', function() {
		is_sunday_open = $(this).val();
		if(is_sunday_open == "close"){
            $('#sunday_closetime').hide('slow');
        }else{
            $('#sunday_closetime').show('slow');
        }
	});
    ...
    <script
        src="https://maps.google.com/maps/api/js?key=AIzaSyDeFCr8crNtmNwVjs9XiKXbvXcJbuczAHs&libraries=places&callback=initAutocomplete"
