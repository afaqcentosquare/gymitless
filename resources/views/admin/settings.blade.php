...
@section('title')
    <title>Gymitless | User Settings</title>
@endsection
@section('content')
    <!--begin::Content-->
                            ...
                            <div class="tab-pane show active px-7" id="kt_user_edit_tab_1" role="tabpanel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-7 my-2">
                                        <!--begin::Group-->
                                        <form class="form" id="kt_form" method="post" action="{{route('admin.settings.update.profile')}}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <div class="input-group input-group-lg input-group-solid">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg form-control-solid" placeholder="(000) 000-0000" name="number" id="userNumber" onkeypress="return numberPressed(event);" value="{{ $user->number }}">
                                                       
                                                    </div>
                                                    <span class="form-text text-muted">We'll never share your phone with
                                                        anyone else.</span>
                                                </div>
                                            </div>
                                            <!--end::Group-->
                                                ...
                                                <div class="col-9">
                                                    <div class="input-group input-group-lg input-group-solid">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            placeholder="anna.krox@loop.com" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end::Group-->
                                            <button type="submit"
                                                class="btn btn-primary btn-pill font-weight-bold font-weight-bolder font-size-sm px-5 btn-fixed-height">Submit</button>
                                        </form>
                                    </div>
                                </div>
                                <!--end::Row-->
                                        ...
                                        <div class="col-xl-7">
                                            <form action="{{route('admin.settings.update.password')}}" method="post">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                                                        <input class="form-control form-control-lg form-control-solid"
                                                            type="current_password" name="current_password"
                                                            placeholder="Please enter your current Password here." />
                                                            @if($errors->has('current_password'))
                                                            <span class="form-text">{{ $errors->first('current_password') }}</span>
                                                            @endif
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                                                        <input class="form-control form-control-lg form-control-solid"
                                                            ...
                                                            <span class="form-text">{{ $errors->first('new_password') }}</span>
                                                            @endif
                                                    </div>
                                                </div>
                                                <!--end::Group-->
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                                                        <input class="form-control form-control-lg form-control-solid"
                                                            ...
                                                            <span class="form-text">{{ $errors->first('verify_password') }}</span>
                                                            @endif
                                                    </div>
                                                </div>
                                                <!--end::Group-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-7">
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    <button type="submit"
                                                        class="btn btn-light-primary font-weight-bold">Save changes</button>
