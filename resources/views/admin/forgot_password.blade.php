...
<head>
    <base href="../../../../">
    <meta charset="utf-8" />
    <title>Gymitless | Forgot Password</title>
            ...
            <div class="login-aside d-flex flex-column flex-row-auto"
                ...
                <div class="d-flex flex-column-auto flex-column py-lg-20 py-10 mb-20">
                    ...
                    <a href="#" class="login-logo text-center pt-lg-10 pb-10">
                        <img src="assets/media/web-panel/logo.png" alt="logo" class="h-250px" />
                    </a>
                    <!--end::Aside header-->
                    <!--begin::Aside Title-->
                    ...
                    <div class="login-form">
                        ...
                        <form class="form" id="kt_login_forgot_form">
                            ...
                            <div class="form-group">
                                <input class="form-control h-auto py-6 border-0 rounded-lg font-size-h6" type="email"
